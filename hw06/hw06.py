class VendingMachine:
    ...
    def add_funds(self, amount):
        if self.stock == 0:
            return 'Nothing left to vend. Please restock. Here is your ${0}.'.format(amount)
        self.balance += amount
    ...
    def vend(self):
        ...
        msg = 'Here is your {0}'.format(self.item)
        if change != 0:
            msg += ' and ${0} change'.format(-change)
        self.balance = 0
        self.stock -= 1
        return msg + '.'
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        return max(self.cents, self.cents + Mint.present_year - self.year - 50)
